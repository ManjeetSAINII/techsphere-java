...
boolean isValidUser = (userType != null && userName != null && password != null && userType.equals("customer"));
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide hero-slide" style="background: linear-gradient(135deg, #7c3aed 0%, #9333ea 45%, #ec4899 100%);">
            <div class="hero-content">
                ...
                <a href="index.jsp?type=mobile" class="hero-btn">Shop Mobiles →</a>
            </div>
        ...
        <div class="swiper-slide hero-slide" style="background: linear-gradient(135deg, #0ea5e9 0%, #3b82f6 45%, #8b5cf6 100%);">
            <div class="hero-content">
                ...
                <a href="index.jsp?type=laptop" class="hero-btn">Shop Laptops →</a>
            </div>
            <div class="hero-image">💻</div>
        </div>
        <!-- Slide 3 -->
        <div class="swiper-slide hero-slide" style="background: linear-gradient(135deg, #f97316 0%, #ef4444 45%, #db2777 100%);">
            <div class="hero-content">
                ...
                <a href="index.jsp?type=tv" class="hero-btn">Shop TVs →</a>
            </div>
            <div class="hero-image">📺</div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2 hidden-sm hidden-xs">
            <div class="ts-widget">
                ...
                <a href="index.jsp" class="ts-cat-link"><span class="ts-emoji">&#128722;</span> All Products</a>
                <a href="index.jsp?type=mobile" class="ts-cat-link"><span class="ts-emoji">&#128241;</span> Mobiles</a>
                <a href="index.jsp?type=laptop" class="ts-cat-link"><span class="ts-emoji">&#128187;</span> Laptops</a>
                <a href="index.jsp?type=tv" class="ts-cat-link"><span class="ts-emoji">&#128250;</span> Smart TVs</a>
                <a href="index.jsp?type=camera" class="ts-cat-link"><span class="ts-emoji">&#128247;</span> Cameras</a>
                <a href="index.jsp?type=speaker" class="ts-cat-link"><span class="ts-emoji">&#128266;</span> Speakers</a>
                <a href="index.jsp?type=tablet" class="ts-cat-link"><span class="ts-emoji">&#128203;</span> Tablets</a>
            </div>
        </div>
        ...
        <div class="col-md-8 col-sm-12 col-xs-12">
            ...
            <div class="row text-center">
                ...
                for (ProductBean product : products) {
                    int cartQty = isValidUser ? new CartServiceImpl().getCartItemCount(userName, product.getProdId()) : 0;
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="prod-body">
                            ...
                            <div class="prod-actions">
                                <% if (!isValidUser) { %>
                                <form><a href="login.jsp" class="btn btn-primary" style="width:100%;text-decoration:none;display:block;">
