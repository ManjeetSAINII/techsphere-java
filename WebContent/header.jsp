...
<body style="background-color: #cee5f2;">
	<!-- Website Header Starting  -->
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #faa307; color: white; padding: 5px;">
		<!-- <h1 style="color:#000000">Welcome To TechSphere!</h1> -->
	<!--	<h6>.</h6> -->
		<form class="form-inline" action="index.jsp" method="get" style="color:#0d3b66; font-weight:bold; font-size:30px; font-style:italic;">Welcome To Tech Sphere!
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>TECH SPHERE</a>
			</div>
